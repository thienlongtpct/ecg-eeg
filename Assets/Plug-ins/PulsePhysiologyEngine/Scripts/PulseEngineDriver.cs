...
public class PulseEngineDriver : PulseDataSource
{
    ...
    public TextAsset[] patientDataFiles;
    ...
    public void StartPulseEngineDriver()
    {
        engine = null;
        isRunning = true;
        startBtn.interactable = false;
        startTxt.text = "Работает...";
        startImg.color = new Color(0f, 1f, 0f, 1f);
        int vl = monitorController.PatientID;
        monitorController.PlayBGM();
        ...
        initialStateFile = patientDataFiles[vl];
